...
if (isset($_GET['id'])) {
	...
	$pdf->setTextShadow(array('enabled'=>true, 'depth_w'=>0.2, 'depth_h'=>0.2, 'color'=>array(196,196,196), 'opacity'=>1, 'blend_mode'=>'Normal'));
		...
		$exp_data = get_check_list_seguros($id);
		...
		$html = '
			<h4 style="text-align: center; color: #566464;">LEASING VEHICULOS</h4>
			<table border="0" cellpadding="5" color="#566464" style="font-size:11px; text-align: left;">
				<tbody>
					...
					<tr>
						...
						<td width="120" style="text-align: center; border-bottom: 1px solid #566464;">'. $cliente_celular .'</td>
					</tr>
					<tr>
						<td width="auto">&nbsp;</td>
					</tr>
					...
					<tr>
						...
						<td width="50">&nbsp;</td>
						<td width="71">Móvil:</td>
						<td width="120" style="text-align: center; border-bottom: 1px solid #566464;">'. $contacto_movil .'</td>
					</tr>
					<tr>
						<td width="auto">&nbsp;</td>
					</tr>
					<tr>
						...
						<td width="165">&nbsp;</td>
						<td width="200"><h4 style="text-align: left;">USO DE LA GARANTÍA</h4></td>
					</tr>
					<tr>
						<td width="70"></td>
						...
						<td width="70"></td>
						<td width="200" style="font-size:12px; text-align: left; border-bottom: 1px solid #566464;">'. $uso_garantia .'</td>
					</tr>
					<tr>
						<td width="auto">&nbsp;</td>
					</tr>
					<tr>
						<td width="auto"><h4 style="text-align: left;">DATOS DE LA PERSONA QUE VA USAR EL BIEN</h4></td>
					</tr>
					<tr>
						<td width="70">Nombre:</td>
						<td width="220" style="font-size:12px; text-align: left; border-bottom: 1px solid #566464;">'. $nombre_usuario .'</td>
						<td width="30">&nbsp;</td>
						<td width="70">Cargo:</td>
						<td width="200" style="font-size:12px; text-align: left; border-bottom: 1px solid #566464;">'. $cargo_usuario .'</td>
					</tr>
					<tr>
						<td width="70">Edad:</td>
						<td width="80" style="font-size:12px; text-align: center; border-bottom: 1px solid #566464;">'. $edad_usuario .' Años</td>
					</tr>
					<tr>
						<td width="auto">&nbsp;</td>
					</tr>
					<tr>
						<td width="200"><h4 style="text-align: left;">SEGURO ADICIONAL</h4></td>
						<td width="120">&nbsp;</td>
						<td width="200"><h4 style="text-align: left;">EN DONDE SE MOVILIZARA?</h4></td>
					</tr>
					<tr>
						<td width="70"></td>
						<td width="250" style="font-size:12px; text-align: left; border-bottom: 1px solid #566464;">'. $seguro_adicional .'</td>
						<td width="70"></td>
						<td width="250" style="font-size:12px; text-align: left; border-bottom: 1px solid #566464;">'. $tipo_lugar_uso .'</td>
					</tr>
					<tr>
						<td width="auto">&nbsp;</td>
					</tr>
