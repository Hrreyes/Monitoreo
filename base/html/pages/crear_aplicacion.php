...
if($_POST){
  ...
  $agregar_aplicacion=$_POST['agregar_aplicacion'];

      
  guardar_aplicacion($agregar_aplicacion); 
...
<body class="animsition">
	...
	<div class="page">
		<div class="page-header">
			<h1 class="page-title">Agregar Aplicacion</h1>
            <ol class="breadcrumb">
                              ...
                              <div class="example-wrap">
                                 ...
                                 <div class="example">
                                    ...
                                    <div class="row">
                                          ...
                                          <label class="form-control-label" for="inputBasicPassword">Agregar Aplicacion</label>
                                          <input type="text" class="form-control" id="inputBasicPassword" name="agregar_aplicacion"
                                          placeholder="+ aplicacion" autocomplete="off" />
