<?php
 $menususuario=obtener_menu($_SESSION['id_rol']);
 //print_r($menususuario);
 //die();
?>

 <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" style="background-color: #00bcd4" role="navigation">
    <div class="navbar-header" style="background-color: #00bcd4">
      ...
      <div class="navbar-brand navbar-brand-center " data-toggle="gridmenu">        
          <img class="navbar-brand-logo" src="../../assets/images/icon.ico" title="Monitoreo">
          <span class="navbar-brand-text hidden-xs-down">Monitoreo</span>
      </div>
...
<!--                   </div>
        ...
        <!-- Navbar Toolbar Right -->
         ...
         <!--li class="nav-item dropdown">
          ...
          <li class="nav-item dropdown" style="background-image: white">
            ...
            <div class="dropdown-menu" role="menu">                 
              ...
              <a class="dropdown-item" href="login.php?out=1" role="menuitem"><i class="icon md-power" aria-hidden="true"></i> Logout <?php Echo $_SESSION['usuario'];?></a>
            </div>
          </li>
          </li>
          </ul>         
...
<!--       <div class="collapse navbar-search-overlap" id="site-navbar-search">
    ...
    <div class="site-menubar" style="background-color: white";>
    <div class="site-menubar-body">
      <div>
        <div>
          <?php foreach($menususuario as $menu)
          //echo $menu['url'];
          //die();
          {?>
          ...
          <ul class="site-menu" data-plugin="menu">
            <li class="site-menu-category"></li>
             <li class="site-menu-item">
              <a class="animsition-link" href="<?php echo $menu['url'];?>">
                <i class="site-menu-icon md-file" aria-hidden="true"></i>
                <span class="site-menu-title ml-0"><?php echo $menu['menu'];?></span>
              </a>
            </li>
           <!-- <li class="site-menu-item">
              <a class="animsition-link" href="">
                <i class="site-menu-icon md-file" aria-hidden="true"></i>
                <span class="site-menu-title ml-0">jjjjjj</span>
              </a>
            </li>-->
            <!-- <li class="site-menu-item has-sub">
              <a href="javascript:void(0)">
                <i class="site-menu-icon md-folder" aria-hidden="true"></i>
                <span class="site-menu-title">Conozca a su cliente</span>
                <span class="site-menu-arrow"></span>
              </a>
              <ul class="site-menu-sub pl-15">
                <li class="site-menu-item">
                  <a class="animsition-link" href="persona_ird.php">
                    <i class="site-menu-icon md-account" aria-hidden="true"></i>
                    <span class="site-menu-title ml-0">Persona Individual</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="persona_ci.php">
                    <i class="site-menu-icon md-accounts" aria-hidden="true"></i>
                    <span class="site-menu-title ml-0">Comerciante Individual</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="persona_jd.php">
                    <i class="site-menu-icon md-accounts-list" aria-hidden="true"></i>
                    <span class="site-menu-title ml-0">Persona Juridica</span>
                  </a>
                </li>
              </ul>
            </li> -->
            ...
            <!--<li class="site-menu-item">
              <a class="animsition-link" href="<?php  ;?>">
                <i class="site-menu-icon md-file" aria-hidden="true"></i>
                <span class="site-menu-title ml-0"><?php// echo $menu['nombre'];?></span>
              </a>
            </li>-->
          <?php } ?>

            <!-- start formulario ive sidebar
            <li class="site-menu-item">
              <a class="animsition-link" href="formulario_ive_home.php">
                <i class="site-menu-icon md-file" aria-hidden="true"></i>
                <span class="site-menu-title ml-0">Formularios IVE-IR-02</span>
              </a>
            </li>-->


            <!-- start Solicitudes sidebar
            <li class="site-menu-item has-sub">
              <a href="javascript:void(0)">
                <i class="site-menu-icon md-folder" aria-hidden="true"></i>
                <span class="site-menu-title">GESTION IVE</span>
                <span class="site-menu-arrow"></span>
              </a>
              <ul class="site-menu-sub pl-15">
                  <li class="site-menu-item">
                    <a class="animsition-link" href="feicJuridicoBusqueda.php">
                    ...
                    <path d="M2 11h1v1H2v-1zm2 0h1v1H4v-1zm-2 2h1v1H2v-1zm2 0h1v1H4v-1zm4-4h1v1H8V9zm2 0h1v1h-1V9zm-2 2h1v1H8v-1zm2 0h1v1h-1v-1zm2-2h1v1h-1V9zm0 2h1v1h-1v-1zM8 7h1v1H8V7zm2 0h1v1h-1V7zm2 0h1v1h-1V7zM8 5h1v1H8V5zm2 0h1v1h-1V5zm2 0h1v1h-1V5zm0-2h1v1h-1V3z"/>
                      ...
                      <span class="site-menu-title ml-0">FEIC Jurídico</span>
                    </a>
                  </li>-->
                  
                  <!--
                  <li class="site-menu-item">-->
                    <!-- <a class="animsition-link" href="feicIndividual.php"> -->
                   <!-- <a class="animsition-link" href="feicIndividualBusqueda.php">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                    <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                    </svg>
                      <span class="site-menu-title ml-0">FEIC Individual</span>
                    </a>
                  </li>
                  <li class="site-menu-item">
                    <a class="animsition-link" href="listadoFeic.php">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-task" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M2 2.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5V3a.5.5 0 0 0-.5-.5H2zM3 3H2v1h1V3z"/>
                    <path d="M5 3.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM5.5 7a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9zm0 4a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9z"/>
                    <path fill-rule="evenodd" d="M1.5 7a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H2a.5.5 0 0 1-.5-.5V7zM2 7h1v1H2V7zm0 3.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5H2zm1 .5H2v1h1v-1z"/>
                    </svg>
                      <span class="site-menu-title ml-0">Listado FEIC</span>
                    </a>
                  </li>                  
              </ul>
            </li>-->
...
<!-- 
            <li class="site-menu-item has-sub">
              <a href="javascript:void(0)">
                <i class="site-menu-icon md-folder" aria-hidden="true"></i>
                <span class="site-menu-title">Formularios IVE-IR-02</span>
                <span class="site-menu-arrow"></span>
              </a>
              <ul class="site-menu-sub pl-15">
                 ...
                 <li class="site-menu-item">
                    <a class="animsition-link" href="formulario_ive_home.php">
                      <i class="site-menu-icon md-accounts" aria-hidden="true"></i>
                      <span class="site-menu-title ml-0">HOME IVE-IR-02</span>
                    </a>
                  </li>

                  <li class="site-menu-item">
                    <a class="animsition-link" href="formulario_ive_ir02.php">
                      <i class="site-menu-icon md-accounts" aria-hidden="true"></i>
                      <span class="site-menu-title ml-0">IVE-IR-02</span>
                    </a>
                  </li>
                  
                  <li class="site-menu-item">
                    <a class="animsition-link" href="formulario_ive_ir02_ai.php">
                      <i class="site-menu-icon md-accounts-list" aria-hidden="true"></i>
                      <span class="site-menu-title ml-0">A.I PRODUCTOS</span>
                    </a>
                  </li>
                  <li class="site-menu-item">
                    <a class="animsition-link" href="formulario_ive_ir02_aii.php">
                      <i class="site-menu-icon md-accounts-list" aria-hidden="true"></i>
                      <span class="site-menu-title ml-0">A.II OTROS FIRMANTES</span>
                    </a>
                  </li>

                  <li class="site-menu-item">
                    <a class="animsition-link" href="formulario_ive_ir02_aiii.php">
                      <i class="site-menu-icon md-accounts-list" aria-hidden="true"></i>
                      <span class="site-menu-title ml-0">A.III PEP</span>
                    </a>
                  </li>

                  <li class="site-menu-item">
                    <a class="animsition-link" href="formulario_ive_ir02_aiv.php">
                      <i class="site-menu-icon md-accounts-list" aria-hidden="true"></i>
                      <span class="site-menu-title ml-0">A.IV BENEFICIARIOS</span>
                    </a>
                  </li>

                  <li class="site-menu-item">
                    <a class="animsition-link" href="formulario_ive_ir02_internobf.php">
                      <i class="site-menu-icon md-accounts-list" aria-hidden="true"></i>
                      <span class="site-menu-title ml-0">INTERNO BENEFICIARIOS FINALES</span>
                    </a>
                  </li>
            ...
            <!--<li class="site-menu-item has-sub">
              ...
              <ul class="site-menu-sub pl-15">
                  <li class="site-menu-item">
                    <a class="animsition-link" href="solicitud_individual_home.php">
                      <i class="site-menu-icon md-accounts" aria-hidden="true"></i>
                      <span class="site-menu-title ml-0">S. de Leasing Individual</span>
                    </a>
                  </li>
                  <li class="site-menu-item">
                    <a class="animsition-link" href="solicitud_comercial_home.php">
                      <i class="site-menu-icon md-accounts" aria-hidden="true"></i>
                      <span class="site-menu-title ml-0">S. de Leasing Comercial</span>
                    </a>
                  </li>
                  <li class="site-menu-item">
                    <a class="animsition-link" href="solicitud_empresarial_home.php">
                      <i class="site-menu-icon md-accounts" aria-hidden="true"></i>
                      <span class="site-menu-title ml-0">S. de Empresarial</span>
                    </a>
                  </li>
                  <li class="site-menu-item">
                    <a class="animsition-link" href="solicitud_listseguros_hoja_negociacion_home.php">
                      <i class="site-menu-icon md-accounts" aria-hidden="true"></i>
                      <span class="site-menu-title ml-0">Hoja de Negociación</span>
                    </a>
                  </li>
              </ul>
            </li>-->
           <!--end Solicitudes ive-->
            ...
            <!-- start List de Seguros sidebar-->
            <!--<li class="site-menu-item has-sub">
              <a href="javascript:void(0)">
                <i class="site-menu-icon md-folder" aria-hidden="true"></i>
                <span class="site-menu-title">CHECK LIST SEGUROS</span>
                <span class="site-menu-arrow"></span>
              </a>
                <ul class="site-menu-sub pl-15">
                  <li class="site-menu-item">
                    <a class="animsition-link" href="solicitud_listseguros_home.php">
                      <i class="site-menu-icon md-accounts" aria-hidden="true"></i>
                      <span class="site-menu-title ml-0">Vehiculos</span>
                    </a>
                  </li>
                  <li class="site-menu-item">
                    <a class="animsition-link" href="solicitud_listseguros_maquinaria_home.php">
                      <i class="site-menu-icon md-accounts" aria-hidden="true"></i>
                      <span class="site-menu-title ml-0">Maquinaria Industrial</span>
                    </a>
                  </li>
                  <li class="site-menu-item">
                    <a class="animsition-link" href="solicitud_listseguros_inmobiliario_home.php">
                      <i class="site-menu-icon md-accounts" aria-hidden="true"></i>
                      <span class="site-menu-title ml-0">Inmobiliario</span>
                    </a>
                  </li>
                  <li class="site-menu-item">
                    <a class="animsition-link" href="solicitud_listseguros_maquinaria_contratista_home.php">
                      <i class="site-menu-icon md-accounts" aria-hidden="true"></i>
                      <span class="site-menu-title ml-0">Maquinaria Contratista</span>
                    </a>
                  </li>
              </ul>
            </li>-->

            <!--end List de Seguros ive-->
...
<!--           <div class="site-menubar-section">
            <h5>
              Relación de Cotización / Conversión
    ...
    <div class="site-menubar-footer" style="background-color: #999">
<!--       <a href="javascript: void(0);" class="fold-show" data-placement="top" data-toggle="tooltip"
      ...
      <a href="login.php?out=1" data-placement="top" align="right" data-toggle="tooltip" data-original-title="Logout">
