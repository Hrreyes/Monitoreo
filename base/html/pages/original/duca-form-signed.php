...
while ($dua_var = mysqli_fetch_assoc($dua_poliza)) {
    ...
    $NO_DUCA                         = ($dua_var["DUCA_POLIZA"]);
    $FIRMA                           = ($dua_var["FIRMA"]);
    $SELECTIVO                       = ($dua_var["SELECTIVO"]);
    $NO_DE_OPERACION                 = ($dua_var["NO_DE_OPERACION"]);
    $FECHA_SELECTIVO                 = ($dua_var["FECHA_SELECTIVO"]);
    $FECHA_ACEPTACION                = ($dua_var["FECHA_ACEPTACION"]);
    $NUMERO_ARCHIVO                  = ($dua_var["NUMERO_ARCHIVO"]);
    ...
    $MODO_TRANSPORTE_PDF             = ($dua_var["MODO_TRANSPORTE"]);
    ...
    $TOTAL_VALOR_TRANSACCION_DOLARES = ($dua_var["TOTAL_VALOR_TRANSACCION_DOLARES"]);
...
$poliza_array         = (str_split($NO_DUCA));
$DUCA_POLIZA_FORMATED = $poliza_array[0] . $poliza_array[1] . $poliza_array[2] . $poliza_array[3] . $poliza_array[4] . $poliza_array[5] . $poliza_array[6] . "-" . $poliza_array[7] . $poliza_array[8] . "-" . $poliza_array[9] . $poliza_array[10] . $poliza_array[11] . $poliza_array[12] . $poliza_array[13] . $poliza_array[14] . "-" . $poliza_array[15] . $poliza_array[16] . $poliza_array[17] . $poliza_array[18] . "-" . $poliza_array[19];

// FORMAT FECHA ACEPTACION
$aceptacion_array     = (str_split($FECHA_ACEPTACION));
$FECHA_ACEPTACION     = $aceptacion_array[0] . $aceptacion_array[1] . "/" . $aceptacion_array[2] . $aceptacion_array[3] . "/" . $aceptacion_array[4] . $aceptacion_array[5] . $aceptacion_array[6] . $aceptacion_array[7];
$FECHA_ACEPTACION_PDF = $aceptacion_array[0] . $aceptacion_array[1] . $aceptacion_array[2] . $aceptacion_array[3] . $aceptacion_array[4] . $aceptacion_array[5] . $aceptacion_array[6] . $aceptacion_array[7];

// FORMAT FECHA SELECTIVO
$aceptacion_array    = (str_split($FECHA_SELECTIVO));
$FECHA_SELECTIVO     = $aceptacion_array[0] . $aceptacion_array[1] . "/" . $aceptacion_array[2] . $aceptacion_array[3] . "/" . $aceptacion_array[4] . $aceptacion_array[5] . $aceptacion_array[6] . $aceptacion_array[7];
$FECHA_SELECTIVO_PDF = $aceptacion_array[0] . $aceptacion_array[1] . $aceptacion_array[2] . $aceptacion_array[3] . $aceptacion_array[4] . $aceptacion_array[5] . $aceptacion_array[6] . $aceptacion_array[7];
...
$NUMERO     = $CODIGO_DECLARANTE . "-" . get_correlativo_for_exp($exp_id);
$ACEPTACION = "";
...
$NOMBRE_PROVEEDOR_SPLIT = str_split($NOMBRE_PROVEEDOR, 50);
$NOMBRE_PROVEEDOR       = $NOMBRE_PROVEEDOR_SPLIT[0];
$NOMBRE_PROVEEDOR2      = $NOMBRE_PROVEEDOR_SPLIT[1];
...
$duca->setCampo('NO_DUCA', $DUCA_POLIZA_FORMATED);
$duca->setCampo('NO_DUCA_PDF', $NO_DUCA);
$duca->setCampo('FECHA_ACEPTACION', $FECHA_ACEPTACION);
$duca->setCampo('FECHA_ACEPTACION_PDF', $FECHA_ACEPTACION_PDF);

// SELECTIVO SAT
if (strlen($SELECTIVO) > 1) {
    $duca->setCampo('SELECTIVO', 'SELECTIVO: ' . $SELECTIVO);
    $duca->setCampo('FECHA_SELECTIVO', 'FECHA: ' . $FECHA_SELECTIVO);
    if (strlen($NO_DE_OPERACION) > 1) {
        $duca->setCampo('NO_DE_OPERACION', 'OPERACION: ' . $NO_DE_OPERACION);
    }
}

//FIRMA SAT
$duca->setCampo('FIRMA', $FIRMA);
$duca->setCampo('NUMERO_ARCHIVO', $NUMERO_ARCHIVO);
...
$duca->setCampo('MODO_TRANSPORTE_PDF', $MODO_TRANSPORTE_PDF);
...
// VALORES TOTALES
$duca->setCampo('VALOR_FOB', number_format($TOTAL_FOB_DOLARES, 2)); // reference only

$duca->setCampo('VALOR_TRANSACCION', number_format($TOTAL_FOB_DOLARES, 2));
...
$duca->setCampo('VALOR_ADUANA_TOTAL', number_format($TOTAL_VALOR_TRANSACCION_DOLARES, 2));
$duca->setCampo('INCOTERM', $INCOTERM);
$duca->setCampo('TASA_CAMBIO', number_format($TIPO_CAMBIO_TRANSACCION, 5));

// PESOS
$duca->setCampo('PESO_BRUTO', number_format($TOTAL_PESO_BRUTO, 3, '.', ','));
$duca->setCampo('PESO_NETO', number_format($TOTAL_PESO_NETO, 3, '.', ','));
