...
$obtener_bitacora=obtener_datos_bitacora();
      ...
      <div class="page-content">
        <div class="panel">
          <header class="panel-heading">
            ...
            <h3 class="panel-title">HISTORIAL BITACORA</h3>
          </header>
                  ...
                  <table class="tablesaw table-striped table-bordered table-hover" data-tablesaw-mode="swipe"
                    ...
                    <tbody>
                      <?php
                        ...
                        foreach($obtener_bitacora as $bitacora){ ?>
                        
                          <td><?php echo $bitacora['codigo'];?></td>
                          <td><?php echo $bitacora['url'];?></td>
                          <td><?php echo $bitacora['nombre'];?></td>
                          <td><?php echo $bitacora['tiempo_revision_pagina'];?></td>
                          <td><?php echo $bitacora['fecha'];?></td>
                          <!--<td><center><a class="btn btn-light" href="detalle_bitacora.php?idbt=<?php echo $bitacora['id'];?>" role="button">Detalle</a></center></td>-->
