<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    <div class="navbar-header" style="background-color: #F03E29">
      ...
      <div class="navbar-brand navbar-brand-center " data-toggle="gridmenu">        
          <img class="navbar-brand-logo" src="user-pics/Triangulo Arrend.png" title="Arrend">
          <span class="navbar-brand-text hidden-xs-down">COMERCIAL</span>
      </div>
         ...
         <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          ...
          <li class="nav-item dropdown">
            ...
            <!--<div class="dropdown-menu" role="menu">
              ...
              <!--<a class="dropdown-item" href="login.php?out=1" role="menuitem"><i class="icon md-power" aria-hidden="true"></i> Logout</a>
            </div>
          </li>
          </li>
          </ul>--->         
      ...
      <div>
        <div>
          <ul class="site-menu" data-plugin="menu">
            <li class="site-menu-category"></li>
             <li class="site-menu-item">
              <a class="animsition-link" href="home.php">
                ...
                <span class="site-menu-title ml-0">Inicio</span>
              </a>
            </li>
            <li class="site-menu-item">
              <a class="animsition-link" href="tickets.php">
                <i class="site-menu-icon md-file" aria-hidden="true"></i>
                <span class="site-menu-title ml-0">Ir a Tickets</span>
              </a>
            </li>
            ...
            <!--<li class="site-menu-item">
              <a class="animsition-link" href="lista_reporte_contacto.php">
                <i class="site-menu-icon md-file" aria-hidden="true"></i>
                <span class="site-menu-title ml-0">Reporte de contacto</span>
              </a>
            </li>-->
