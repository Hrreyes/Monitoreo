        ...
        <div class="page-content">
          <div class="panel">
            <header class="panel-heading">
               ...
               <h3 class="panel-title">CONFIGURAR NOTIFICACIONES</h3>
            </header>
                           ...
                           <div class="col-md-6">
                              ...
                              <div class="example-wrap">
                                 <h4 class="example-title">Datos Paginas</h4>
                                    ...
                                    <div>
                                        <?php $cargar_paginas=obtener_paginas();?>
                                            <label class="form-control-label" for="inputBasicPassword">Seleccionar Pagina</label>
                                            <div class="example">
                                                <select class="form-control" data-plugin="select" name="pagina">
                                                    <?php
                                                    foreach($cargar_paginas as $pages){?>
                                                          
                                                    <option value="<?php echo $pages['id'];?>"><?php echo $pages['url'];?></option>
                                                    <?php }?>       
                                    ...
                                    <div>
                                        <?php $cargar_usuario=lista_usuarios();?>
                                            <label class="form-control-label" for="inputBasicPassword">Asignar Pagina</label>
                                            <div class="example">
