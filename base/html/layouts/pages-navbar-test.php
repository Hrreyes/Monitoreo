  ...
  <div class="site-menubar">
    <div class="site-menubar-body">
      <div>
        <div>
	      ...
	      <!--      <li class="site-menu-item ">
	              <a class="animsition-link" href="servicios-simples.php">
	                <i class="site-menu-icon md-collection-item" aria-hidden="true"></i>
	                <span class="site-menu-title">Servicios Simples</span>
	              </a>
	            </li>
	            ...
	            <li class="site-menu-item ">
	              <a class="animsition-link" href="servicios.php">
	                <i class="site-menu-icon md-collection-text" aria-hidden="true"></i>
	                <span class="site-menu-title">Servicios Completos</span>
	              </a>
	            </li>
	        -->	            
	            ...
	            <li class="site-menu-item has-sub">
	              <a href="javascript:void(0)">
	                <i class="site-menu-icon md-file" aria-hidden="true"></i>
	                <span class="site-menu-title">Documentos</span>
	                <span class="site-menu-arrow"></span>
	              </a>
	              <ul class="site-menu-sub">
		            ...
		            <li class="site-menu-item ">
		              <a class="animsition-link" href="search-doctos-servicios.php">
		                ...
		                <span class="site-menu-title">Servicios Aduanales</span>
		              </a>
		            </li>
		            ...
		            <li class="site-menu-item ">
		              <a class="animsition-link" href="plantilla-documentos.php">
		                <i class="site-menu-icon md-search-in-file" aria-hidden="true"></i>
		                <span class="site-menu-title">Servicios Generales</span>
		              </a>
		            </li>
		            ...
		            <li class="site-menu-item ">
		              <a class="animsition-link" href="search-doctos-asociados.php">
		                <i class="site-menu-icon md-search-in-file" aria-hidden="true"></i>
		                <span class="site-menu-title">Formulación Aduanal</span>
		              </a>
		            </li>
		            ...
		            <li class="site-menu-item ">
		              <a class="animsition-link" href="search-doctos-usuario.php">
		                <i class="site-menu-icon md-search-in-file" aria-hidden="true"></i>
		                <span class="site-menu-title">Documentos de Usuario</span>
		              </a>
		            </li>
		            ...
		            <li class="site-menu-item ">
		              <a class="animsition-link" href="search-tablas-asociadas.php">
		                <i class="site-menu-icon md-search-in-file" aria-hidden="true"></i>
		                <span class="site-menu-title">Tablas Asociados</span>
		              </a>
		            </li> 
		          <!--  
		            <li class="site-menu-item ">
		              <a class="animsition-link" href="new-servicio-docto.php">
		                <i class="site-menu-icon md-plus-square" aria-hidden="true"></i>
		                <span class="site-menu-title">Crear Documento</span>
		              </a>
		            </li>
		           --> 	                
	              </ul>
	...
	<li class="site-menu-item has-sub">
             ...
             <ul class="site-menu-sub">
	            ...
	            <li class="site-menu-item ">
	              <a class="animsition-link" href="new-articulo.php">
	                <i class="site-menu-icon md-plus" aria-hidden="true"></i>
